...
const URL = 'http://localhost:3000/actualites/agenda-a-la-une/fete-du-velo-en-touraine'
const CHROME = 'C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe'
const SHOTS = [
  { name: 'event-desktop-1280', width: 1280, height: 1000 },
  { name: 'event-tablet-768', width: 768, height: 1100 },
  { name: 'event-mobile-375', width: 375, height: 1200 },
]
